"""
Crop Yield Prediction Streamlit App - Real-time Version
======================================================

A comprehensive Streamlit application for crop yield prediction with real-time
updates when input parameters change.
...
def main():
    ...
    # Main header
    st.markdown('<h1 class="main-header">Crop Yield Predictor - Real-time</h1>', unsafe_allow_html=True)
    ...
    with st.expander("Debug Information"):
        ...
        st.json(input_data)
        st.write("**Encoded Parameters:**")
        st.json(encode_categorical_features(input_data))
    
    # Footer
    st.markdown("---")
    st.markdown("""
    <div style='text-align: center; color: #666;'>
        <p>Crop Yield Predictor - Real-time | Built with Streamlit & Machine Learning</p>
        <p>Predictions update automatically as you adjust parameters</p>
    </div>
    """, unsafe_allow_html=True)
