...
Random Forest and Linear Regression models. Features include:

- Interactive input forms for weather, soil, and farming parameters
- Real-time crop yield predictions with confidence intervals
- Visual feedback with charts, gauges, and progress bars
...
def create_input_form():
    ...
    # Weather Parameters
    st.sidebar.subheader("🌤️ Weather Parameters")
        ...
        if st.button("🚀 Predict Crop Yield", type="primary", use_container_width=True):
            with st.spinner('Calculating prediction...'):
                ...
                if prediction is not None:
                    ...
                    st.markdown(f"### {status_emoji} Yield Status: **{yield_status}**")
